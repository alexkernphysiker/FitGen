...
const vector<value<>> &FitPoints::Point::X() const
{
    return XX;
}
...
const value<> &FitPoints::Point::y() const
{
    return yy;
}
value<> &FitPoints::Point::var_y()
{
    return yy;
}
...
const ParamSet &FitPoints::min()const
{
    return m_min;
}
const ParamSet &FitPoints::max()const
{
    return m_max;
}
const double &FitPoints::Ymax() const
{
    return ymax;
}
const double &FitPoints::Ymin() const
{
    return ymin;
}
