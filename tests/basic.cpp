...
TEST(AbstractGenetic, InitAsync3)
{
    test_init(3, 10);
}
...
TEST(AbstractGenetic, InitAsync3_)
{
    test_init(3, 5);
}
TEST(AbstractGenetic, InitAsync4_)
{
    test_init(4, 5);
}
...
TEST(AbstractGenetic, InitAsync3__)
{
    test_init(3, 2);
}
TEST(AbstractGenetic, InitAsync4__)
{
    test_init(4, 2);
}
#endif
...
TEST(AbstractGenetic, ItAsync3)
{
    test_iterate(3, 10, 100);
}
TEST(AbstractGenetic, ItAsync4)
{
    test_iterate(4, 10, 100);
}
TEST(AbstractGenetic, ItAsync5)
{
    test_iterate(5, 10, 100);
}
TEST(AbstractGenetic, ItAsync6)
{
    test_iterate(6, 10, 100);
}
TEST(AbstractGenetic, ItAsync7)
{
    test_iterate(7, 10, 100);
}
...
TEST(AbstractGenetic, ItAsync3_)
{
    test_iterate(3, 5, 5);
}
TEST(AbstractGenetic, ItAsync4_)
{
    test_iterate(4, 5, 5);
}
TEST(AbstractGenetic, ItAsync5_)
{
    test_iterate(5, 5, 5);
}
TEST(AbstractGenetic, ItAsync6_)
{
    test_iterate(6, 5, 5);
}
TEST(AbstractGenetic, ItAsync7_)
{
    test_iterate(7, 5, 5);
}
TEST(AbstractGenetic, ItAsync8_)
{
    test_iterate(8, 5, 5);
}
...
TEST(AbstractGenetic, ItAsync3__)
{
    test_iterate(3, 2, 5);
}
TEST(AbstractGenetic, ItAsync4__)
{
    test_iterate(4, 2, 5);
}
TEST(AbstractGenetic, ItAsync5__)
{
    test_iterate(5, 2, 5);
}
TEST(AbstractGenetic, ItAsync6__)
{
    test_iterate(6, 2, 5);
}
TEST(AbstractGenetic, ItAsync7__)
{
    test_iterate(7, 2, 5);
}
TEST(AbstractGenetic, ItAsync8__)
{
    test_iterate(8, 2, 5);
}
#endif
